...
sealed class GlobalAccountDataEventType: Disposable  {
     ...
     *
     * This variant can also be deserialized from the `m.room.image_pack` type.
     */
     ...
     * m.image_pack.rooms
     *
     * This variant can also be deserialized from the `im.ponies.emote_rooms` type.
     */
...
sealed class StateEventType: Disposable  {
     ...
     * m.room.image_pack
     *
     * This variant can also be deserialized from the `im.ponies.room_emotes` type.
     */
    ...
    override fun destroy() {
        when(this) {
            is StateEventType.Bridge -> {// Nothing to destroy
            }
            ...
            is StateEventType.SpaceCatchAll -> {// Nothing to destroy
            }
...
public object FfiConverterTypeStateEventType : FfiConverterRustBuffer<StateEventType>{
    override fun read(buf: ByteBuffer): StateEventType {
        return when(buf.getInt()) {
            1 -> StateEventType.Bridge
            2 -> StateEventType.PolicyRuleRoom
            3 -> StateEventType.PolicyRuleServer
            4 -> StateEventType.PolicyRuleUser
            5 -> StateEventType.RoomAvatar
            6 -> StateEventType.RoomCanonicalAlias
            7 -> StateEventType.RoomCreate
            8 -> StateEventType.RoomEncryption
            9 -> StateEventType.RoomGuestAccess
            10 -> StateEventType.RoomHistoryVisibility
            ...
            24 -> StateEventType.SpaceCatchAll
            25 -> StateEventType.RoomImagePack
...
sealed class TimelineEventType: Disposable  {
     ...
     * m.bridge
     */
    object Bridge : TimelineEventType()
     ...
     * de.spiritcroc.space.catch_all
     */
    object SpaceCatchAll : TimelineEventType()
    ...
    override fun destroy() {
        when(this) {
            ...
            is TimelineEventType.Bridge -> {// Nothing to destroy
            }
            ...
            is TimelineEventType.SpaceCatchAll -> {// Nothing to destroy
            }
...
public object FfiConverterTypeTimelineEventType : FfiConverterRustBuffer<TimelineEventType>{
    override fun read(buf: ByteBuffer): TimelineEventType {
        return when(buf.getInt()) {
            ...
            40 -> TimelineEventType.Bridge
            41 -> TimelineEventType.PolicyRuleRoom
            42 -> TimelineEventType.PolicyRuleServer
            43 -> TimelineEventType.PolicyRuleUser
            44 -> TimelineEventType.RoomAvatar
            45 -> TimelineEventType.RoomCanonicalAlias
            46 -> TimelineEventType.RoomCreate
            47 -> TimelineEventType.RoomEncryption
            48 -> TimelineEventType.RoomGuestAccess
            49 -> TimelineEventType.RoomHistoryVisibility
            ...
            63 -> TimelineEventType.SpaceCatchAll
            64 -> TimelineEventType.RoomImagePack
